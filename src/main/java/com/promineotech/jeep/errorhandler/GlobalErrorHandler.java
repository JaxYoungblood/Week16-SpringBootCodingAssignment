...
public class GlobalErrorHandler {
  ...
  }//end MAP handleIllegalArgumentException
  ...
  public Map<String, Object> handleConstraintViolationException(ConstraintViolationException e, WebRequest webRequest){
    return createExceptionMessage(e, HttpStatus.BAD_REQUEST, webRequest, LogStatus.MESSAGE_ONLY);
  }//end MAP handleConstraintViolationException
  ...
  }//end MAP handleNoSuchElementException
  ...
  private Map<String, Object> createExceptionMessage(
    ...
    return error;
  }//end MAP createExceptionMessage
